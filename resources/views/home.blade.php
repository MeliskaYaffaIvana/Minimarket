...
<html lang="en">
    <head>
        ...
        <link type="t4ext/css" href="{{asset('assets/bootstrap/css/bootstrap-responsive.min.css')}}" rel="stylesheet">
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">Minimarket </a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="activity.html"><i class="menu-icon icon-bullhorn"></i>Categories </a>
                                </li>
                                <li><a href="message.html"><i class="menu-icon icon-inbox"></i>Items <b class="label green pull-right">
                                    11</b> </a></li>
                                <li><a href="task.html"><i class="menu-icon icon-tasks"></i>Supplier <b class="label orange pull-right">
                                    19</b> </a></li>
                            </ul>
                            <!--/.widget-nav-->
